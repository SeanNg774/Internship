...
var _index = require("./NativeEntryPlugin/index.js");
var _index2 = require("./OutputPlugin/index.js");
var _index3 = require("./RepackTargetPlugin/index.js");
...
class RepackPlugin {
  ...
  apply(__compiler) {
    ...
    new _index.NativeEntryPlugin({
      initializeCoreLocation: this.config.initializeCore
    }).apply(compiler);
    new _index3.RepackTargetPlugin().apply(compiler);
