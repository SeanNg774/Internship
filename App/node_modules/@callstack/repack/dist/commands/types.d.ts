...
export type RemoveRecord<T> = T extends infer U & Record<string, any> ? U : never;
type ConfigKeys = 'name' | 'context' | 'mode' | 'devServer' | 'entry' | 'optimization' | 'output' | 'resolve';
export type ConfigurationObject = Partial<Record<ConfigKeys, any>>;
export type Configuration<T> = T | ((env: EnvOptions, argv: Record<string, any>) => T | Promise<T>);
export {};
