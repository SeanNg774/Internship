...
export declare const DEFAULT_WEBPACK_CONFIG_LOCATIONS: string[];
/** Default rspack config locations. */
export declare const DEFAULT_RSPACK_CONFIG_LOCATIONS: string[];
/**
 ...
 */
export declare const DEV_SERVER_ASSET_TYPES: RegExp;
