...
import { NormalizedScriptLocatorHTTPMethod, NormalizedScriptLocatorSignatureVerificationMode } from './NativeScriptManager.js';
...
export class Script {
   ...
   */
  static getScriptUniqueId(scriptId, caller) {
  ...
  static from(key, locator, fetch) {
    ...
    const verifyScriptSignature = locator.verifyScriptSignature ?? NormalizedScriptLocatorSignatureVerificationMode.OFF;
    const publicKey = normalizePublicKey(locator.publicKey, verifyScriptSignature);
    return new Script(key.scriptId, key.caller, {
      uniqueId,
      method: locator.method ?? NormalizedScriptLocatorHTTPMethod.GET,
      url: locator.url,
  ...
  checkIfCacheDataOutdated(cachedData) {
    return cachedData.method !== this.locator.method || cachedData.url !== this.locator.url || cachedData.query !== this.locator.query || !shallowEqual(cachedData.headers, this.locator.headers) || cachedData.body !== this.locator.body || cachedData.publicKey !== this.locator.publicKey;
  }
