...
export declare function getMinimizerConfig(bundler: 'rspack' | 'webpack', rootDir: string): Promise<(TerserPlugin<import(".pnpm/terser@5.49.0/node_modules/terser", { with: { "resolution-mode": "import" } }).MinifyOptions> | {
    name: string;
