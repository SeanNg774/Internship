...
async function start(_, cliConfig, args) {
  ...
  (0, _index3.setupEnvironment)(args);
  const maxWorkers = args.maxWorkers ?? (0, _index3.getMaxWorkers)();
  (0, _index3.setupRspackEnvironment)(maxWorkers.toString());
